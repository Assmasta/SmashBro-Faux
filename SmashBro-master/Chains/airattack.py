...
class AirAttack(Chain):
    ...
    def step(self, gamestate, smashbro_state, opponent_state):
        ...
        if smashbro_state.action in [Action.LANDING, Action.UAIR_LANDING, Action.FALLING]:
        ...
        if self.height_level == 2:
            # Attack on frame 11
            if smashbro_state.action in [Action.JUMPING_FORWARD, Action.JUMPING_BACKWARD] and smashbro_state.action_frame >= 11:
