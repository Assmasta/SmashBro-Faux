...
class Laser(Chain):
    ...
    def step(self, gamestate, smashbro_state, opponent_state):
        ...
        if smashbro_state.action in [Action.TURNING, Action.STANDING, Action.LANDING]:
        ...
        if smashbro_state.action in [Action.EDGE_TEETERING_START, Action.EDGE_TEETERING]:
            self.interruptible = True
            controller.tilt_analog(Button.BUTTON_MAIN, int(not smashbro_state.facing), 0.5)
            return
